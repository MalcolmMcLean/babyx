/*
  ...
  version 1.3 - added coment to clarify that flag-less programs should pass null fro flags
 */
#include <stdio.h>
#include <stdlib.h>
#include <stdarg.h>
...
/*
  ...
  Params: argc - number of arguments 
          ...
          flags - list of legitimate 1 character flags (NULL to accept no flags)
